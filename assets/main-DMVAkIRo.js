import{c as e,h as t,i as n,p as r,r as i}from"./editor.api2-DuvA-XEt.js";import{f as a,n as o,t as s}from"./monaco-theme-CoTy5nKt.js";var c={examples:`EXAMPLES`,projects:`PROJECTS`},l=null;function u(e,t){if(l===e){d();return}l=e;let n=document.getElementById(`menu-inner`);n.innerHTML=``,t(n),document.getElementById(`menu-accordion`).classList.add(`open`),requestAnimationFrame(()=>{document.documentElement.style.setProperty(`--accordion`,n.offsetHeight+`px`)}),f()}function d(){l=null,document.getElementById(`menu-accordion`).classList.remove(`open`),document.documentElement.style.setProperty(`--accordion`,`0px`),f()}function f(){for(let e of Object.keys(c)){let t=document.getElementById(e+`-btn`);if(!t)continue;let n=l===e;t.textContent=c[e]+(n?` ▴`:` ▾`),t.setAttribute(`aria-expanded`,String(n))}}var p={"Dice Basics":{"Simple dice":`// Basic dice pools — display() takes one options object
